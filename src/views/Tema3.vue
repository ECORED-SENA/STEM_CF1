  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .contenedor.traslapeTop.traslapeBottom.bg3 
      ...
      .row.align-items-center.mb-5
        .col-lg-4
          figure
            img(src='@/assets/curso/t3/f7.png' alt='imagen relacionada')
        .col-lg-8
